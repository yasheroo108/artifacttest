...
if mnmode == "Surface Area":
    ...
    if shape == "Pyramid":
        ...
        if base == 3:
            st.latex(r"SA = \frac{bh+s(b+x+y)}{2}")
        ...
        if base == 4:
            ...
            if fourmode == "Trapezoid":
                st.latex(r"SA = \frac{s(x+y)+(h+s)(a+b)}{2}")
